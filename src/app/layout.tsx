...
import PartMindFloating from '@/components/ai/PartMindFloating';
...
export const metadata: Metadata = {
  ...
  keywords: ['pièces camion', 'références OEM', 'pièces poids lourds', 'Volvo', 'DAF', 'Scania', 'MAN', 'Mercedes-Benz', 'Renault Trucks', 'Iveco'],
};
