          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="animate-fade-up">
              ...
              <h1 className="max-w-3xl text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-[3.5rem] lg:leading-[1.08]">
                Find the right part for your <span className="nt-gradient-text">truck.</span>
              </h1>
              <p className="mt-5 max-w-xl text-base leading-7 text-slate-400 sm:text-lg">
                Search OEM references, part numbers, truck models and aftermarket equivalents in one structured industrial catalogue built for workshop workflows.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs font-semibold">
                {['OEM number', 'Part number', 'Truck model', 'Manufacturer'].map((label) => (
                  <span key={label} className="rounded-md border border-slate-700/80 bg-slate-900/60 px-3 py-1.5 text-slate-400">{label}</span>
                ))}
              </div>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/search" className="inline-flex items-center gap-2 rounded-lg bg-sky-500 px-5 py-3 text-sm font-bold text-slate-950 shadow-lg shadow-sky-500/25 transition hover:-translate-y-0.5 hover:bg-sky-400">Advanced search <ArrowRight size={16} /></Link>
