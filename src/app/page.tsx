...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <section className="nt-hero-grid border-b border-slate-800" aria-labelledby="hero-heading">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="animate-fade-up">
              <div className="nt-badge mb-6">
                <FileCheck size={13} aria-hidden /> Professional truck parts catalogue
              </div>
              <h1 id="hero-heading" className="max-w-3xl text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-[3.5rem] lg:leading-[1.08]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                >
                  Advanced search <ArrowRight size={16} aria-hidden />
                </Link>
                <Link
                  href="/trucks"
                ...
                >
                  <Truck size={16} aria-hidden /> Select truck
                </Link>
              </div>
            </div>
            <div className="animate-fade-up rounded-2xl border border-slate-700/80 bg-slate-900/80 p-6 shadow-2xl shadow-black/30 backdrop-blur">
              ...
              <div className="mt-4 flex items-start gap-2.5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-3.5 text-xs leading-5 text-emerald-300">
                ...
                <span>
                  <b className="text-emerald-200">Verification-aware:</b> OEM references are separated
                  from unverified fitment data.
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="border-b border-slate-200 bg-white" aria-label="Catalogue statistics">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8" aria-labelledby="manufacturers-heading">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-sky-600">Browse by vehicle</p>
            <h2 id="manufacturers-heading" className="mt-2 text-3xl font-black tracking-tight text-slate-900">
              Truck manufacturers
            </h2>
        ...
        <div className="mt-8 text-center sm:hidden">
          <Link href="/trucks" className="inline-flex items-center gap-1 text-sm font-bold text-sky-700">
            View all manufacturers <ChevronRight size={16} aria-hidden />
          </Link>
        </div>
      </section>

      <section className="border-y border-slate-200 bg-white py-16" aria-labelledby="why-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 max-w-2xl">
            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-sky-600">Why NTParts</p>
            <h2 id="why-heading" className="mt-2 text-3xl font-black tracking-tight text-slate-900">
          ...
          <div className="grid gap-8 p-8 md:grid-cols-[1.25fr_0.75fr] md:p-12">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/10 px-3 py-1 text-xs font-bold text-sky-300">
                <Layers size={13} aria-hidden /> Systems coverage
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                >
                  Browse all parts <ArrowRight size={15} aria-hidden />
                </Link>
                <Link
                  href="/search"
                ...
                >
                  <Search size={15} aria-hidden /> Start searching
                </Link>
              </div>
            </div>
...
function InfoCard({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition hover:border-sky-200 hover:shadow-md">
      <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-slate-900 text-sky-400">{icon}</div>
