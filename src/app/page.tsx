...
import { Search, Truck, ArrowRight, ShieldCheck, Database, ChevronRight, Settings2, PackageSearch, FileCheck } from 'lucide-react';
    ...
    <section className="border-b border-slate-200 bg-white">
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-12 sm:px-6 lg:px-8 lg:pb-20 lg:pt-16">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_430px]">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-700"><FileCheck size={14}/> Professional truck parts catalogue</div>
