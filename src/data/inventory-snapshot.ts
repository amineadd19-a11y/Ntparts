...
/**
 * Count of well-formed line-level [reference, quantity] pairs recovered from the
 * Inventaire.pdf snapshot payload (corrupt gzip CRC repaired; no fabricated lines).
 */
